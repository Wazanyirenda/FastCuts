...
-- CreateEnum
CREATE TYPE "WorkspacePlan" AS ENUM ('FREE', 'STARTER', 'CREATOR', 'PRO');
...
-- CreateIndex
CREATE UNIQUE INDEX "Usage_workspaceId_monthStart_key" ON "Usage"("workspaceId", "monthStart");

-- CreateIndex
CREATE INDEX "AffiliateClick_affiliateId_anonId_createdAt_idx" ON "AffiliateClick"("affiliateId", "anonId", "createdAt");
